...
function Main() {
    ...
    function addActive(e){
        ...
        if(e.target.className == 'card'){
            ...
            console.log(e.target.className)
            e.target.childNodes[0].className = 'mainBorder active'
            e.target.childNodes[1].className = 'side1 active'
            e.target.childNodes[2].className = 'side2 active'
        } else if ( e.target.className == 'card active') {
            e.target.className = 'card'
            e.target.childNodes[0].className = 'mainBorder'
            e.target.childNodes[1].className = 'side1'
            e.target.childNodes[2].className = 'side2'
        }
    }
    ...
    <div id={item.id} key={item.id} onClick={addActive} className='card' >
        ...
        <p>{item.description === '' ? 'Marvel API contained no information' : item.description}</p>
        </div>
        <div className='side2'>
    ...
    return (
        <div className='container'>
            <Search testClick={searchAPI} handleChange={handleChange}/>
        ...
        <div>
        <div className='gallery'>
        <input id='searchVal' type='text' onChange={handleChange}></input>
